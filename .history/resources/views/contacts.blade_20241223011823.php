...
@section('main-container')
		...
		<div class="wrapper">
			...
			<section class="section kf-started-inner">
				<div class="kf-parallax-bg js-parallax" style="background-image: url(frontend/assets/frontend/assets/images/menu_reservation_inner_bg.jpg);"></div>
				<div class="container">
			...
			<section class="section kf-contacts-form">
				<div class="container">
					...
					<div class="kf-reservation-form element-anim-1 scroll-animate" data-animate="active">
						...
						<form id="cform" action="{{ route('contacts_submit_record') }}" method="post">
							@csrf
							<div class="row">
