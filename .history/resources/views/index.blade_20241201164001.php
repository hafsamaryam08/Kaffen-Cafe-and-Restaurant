...
<head>
    ...
    <meta property="og:image" content="frontend/assets/images/og-image.jpg">
	...
	<!-- BEGIN CSS STYLES -->
	<link rel="stylesheet" href="frontend/assets/styles/bootstrap.css" type="text/css" media="all" />
...
<body>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 align-center">
						...
						<div class="kf-main-menu">
							<ul>
								<li>
									<a href="#">Home<i class="las la-angle-down"></i></a>
									<ul>
								...
								<li>
									<a href="#">Menu<i class="las la-angle-down"></i></a>
									<ul>
				...
				<div class="kf-main-menu">
					<ul>
						<li class="has-children">
							...
							<ul>
								<li><a href="index-2.html">Coffee House</a></li>
		...
		<div class="wrapper">
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							...
							<div class="kf-started-item">
								<div class="slide js-parallax" style="background-image: url(frontend/assets/images/started_img_n6.jpg);"></div>
								<div class="container">
						...
						<div class="swiper-slide">
							...
							<div class="kf-started-item">
								<div class="slide js-parallax" style="background-image: url(frontend/assets/images/started_img_n5.jpg);"></div>
								<div class="container">
									<div class="description align-left element-anim-1">
										<div class="subtitles">
											Welcome to the Kaffen
						...
						<div class="swiper-slide">
							...
							<div class="kf-started-item">
								<div class="slide js-parallax" style="background-image: url(frontend/assets/images/started_img_n3.jpg);"></div>
								<div class="container">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">
							...
							<div class="kf-about-quote element-anim-1 scroll-animate" data-animate="active">
								<img src="frontend/assets/images/quote_img.png" alt="" />
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
							...
							<div class="kf-about-image element-anim-1 scroll-animate" data-animate="active">
								<img src="frontend/assets/images/about_img.png" alt="" />
							</div>
				...
				<div class="container">
					...
					<div class="kf-services-items row">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
							<div class="kf-services-item element-anim-1 scroll-animate" data-animate="active">
								<div class="image kf-image-hover">
									<a href="menu-restaurant.html"><img src="frontend/assets/images/service1.jpg" alt="" /></a>
								</div>
								<div class="desc">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
							<div class="kf-services-item element-anim-1 scroll-animate" data-animate="active">
								<div class="image kf-image-hover">
									<a href="menu-coffee.html"><img src="frontend/assets/images/service2.jpg" alt="" /></a>
								</div>
								<div class="desc">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
							<div class="kf-services-item element-anim-1 scroll-animate" data-animate="active">
								<div class="image kf-image-hover">
									<a href="services.html"><img src="frontend/assets/images/service3.jpg" alt="" /></a>
								</div>
								<div class="desc">
			...
			<!-- Section Menu -->
			<section class="section kf-menu kf-parallax" style="background-image: url(frontend/assets/images/category_bg.jpg);">
				<div class="container">
			...
			<section class="section kf-choose section-bg">
				<div class="container">
					<div class="kf-parallax-icon pi-1" data-jarallax-element="-60">
						<div class="p-icon" style="background-image: url(frontend/assets/images/parallax_icon1.png);"></div>
					</div>
					<div class="kf-parallax-icon pi-2" data-jarallax-element="-80">
						<div class="p-icon" style="background-image: url(frontend/assets/images/parallax_icon2.png);"></div>
					</div>
					<div class="kf-parallax-icon pi-3" data-jarallax-element="-40">
						<div class="p-icon" style="background-image: url(frontend/assets/images/parallax_icon3.png);"></div>
					</div>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
							...
							<div class="kf-choose-image element-anim-1 scroll-animate" data-animate="active">
								<img src="frontend/assets/images/choose_img.jpg" alt="" />
							</div>
	  		...
	  		<div class="row">
	  				...
	  				<div class="kf-f-contact element-anim-1 scroll-animate" data-animate="active">
	  					...
	  					<ul>
	  						<li>
	  							...
	  							<em>Location :</em>
	  							Super market, F-6 Markaz, Islamabad
	  						</li>
	  						<li>
	  							<i class="las la-envelope-open-text"></i>
	  							<em>Email Address :</em>
	  							kaffencafe@gmail.com
	  						</li>
	  						<li>
	  			...
	  			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
	  				...
	  				<div class="kf-f-gallery element-anim-1 scroll-animate" data-animate="active">
	  					...
	  					<ul>
	  						<li>
	  							<a href="frontend/assets/images/grid_gal1.jpg" class="kf-image-hover has-popup-image"><img src="frontend/assets/images/grid_gal1.jpg" alt="" /></a>
	  						</li>
	  						<li>
	  							<a href="frontend/assets/images/grid_gal2.jpg" class="kf-image-hover has-popup-image"><img src="frontend/assets/images/grid_gal2.jpg" alt="" /></a>
	  						</li>
	  						<li>
	  							<a href="frontend/assets/images/grid_gal3.jpg" class="kf-image-hover has-popup-image"><img src="frontend/assets/images/grid_gal3.jpg" alt="" /></a>
	  						</li>
	  						<li>
	  							<a href="frontend/assets/images/grid_gal4.jpg" class="kf-image-hover has-popup-image"><img src="frontend/assets/images/grid_gal4.jpg" alt="" /></a>
	  						</li>
	  						<li>
	  							<a href="frontend/assets/images/grid_gal5.jpg" class="kf-image-hover has-popup-image"><img src="frontend/assets/images/grid_gal5.jpg" alt="" /></a>
	  						</li>
	  						<li>
	  							<a href="frontend/assets/images/grid_gal6.html" class="kf-image-hover has-popup-image"><img src="frontend/assets/images/grid_gal1.jpg" alt="" /></a>
	  						</li>
	  					</ul>
	  				</div>
	  		...
	  		<div class="row">
	  			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 align-center">
	  				...
	  				<div class="kf-copyright element-anim-1 scroll-animate" data-animate="active">
	  					© 2024 Kaffen - Cafe & Restaurant | All Rights Reserved
	  				</div>
	...
	<script src="frontend/assets/js/splitting.js"></script>
	...
	<script src="frontend/assets/js/jquery.scrolla.js"></script>
	<script src="frontend/assets/js/skrollr.js"></script>
