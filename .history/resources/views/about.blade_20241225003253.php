					...
					<div class="kf-team-items row">
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
							<div class="kf-team-item element-anim-1 scroll-animate" data-animate="active">
								<div class="desc">
									<h5 class="name">Ali Raza</h5>
									<div class="subname">Senior Chef</div>
								</div>
								<div class="image kf-image-hover">
									<img src="frontend/assets/images/team1.jpg" alt="" />
									<div class="info">
										<div class="label">aliraza@gmail.com</div>
										<div class="label">+92 300 123 4567</div>
									</div>
									<div class="social">
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
							<div class="kf-team-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="image kf-image-hover">
									...
									<div class="info">
									<div class="label">fatimakhan@gmail.com</div>
									<div class="label">+92 301 234 5678</div>
									</div>
									<div class="social">
										<a href="#"><i class="fab fa-facebook-f"></i></a>
										<a href="#"><i class="fab fa-twitter"></i></a>
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
							<div class="kf-team-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="image kf-image-hover">
									...
									<div class="info">
										<div class="label">rafeybhatti@gmail.com</div>
										<div class="label">+92 302 345 6789</div>
									</div>
									<div class="social">
										<a href="#"><i class="fab fa-facebook-f"></i></a>
										<a href="#"><i class="fab fa-twitter"></i></a>
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
							<div class="kf-team-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="image kf-image-hover">
									...
									<div class="info">
										<div class="label">hafsamaryam@gmail.com</div>
										<div class="label">+92 303 456 7890</div>
									</div>
									<div class="social">
										<a href="#"><i class="fab fa-facebook-f"></i></a>
										<a href="#"><i class="fab fa-twitter"></i></a>
