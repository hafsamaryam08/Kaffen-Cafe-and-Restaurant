							...
							<div class="kf-category-items element-anim-1 scroll-animate" data-animate="active">
								<div class="kf-category-item">
									<div class="image kf-image-hover">
										<a href="{{ route('menu-restaurant') }}"><img src="frontend/assets/images/category1.jpg" alt="" /></a>
									</div>
									<div class="desc">
								...
								<div class="kf-category-item">
									<div class="image kf-image-hover">
										<a href="{{ route('menu-restaurant') }}"><img src="frontend/assets/images/category2.jpg" alt="" /></a>
									</div>
									<div class="desc">
								...
								<div class="kf-category-item">
									<div class="image kf-image-hover">
										<a href="{{ route('menu-restaurant') }}"><img src="frontend/assets/images/category3.jpg" alt="" /></a>
									</div>
									<div class="desc">
