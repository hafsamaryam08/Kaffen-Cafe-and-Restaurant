						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
							<div class="kf-blog-grid-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="desc">
									...
									<div class="kf-date"><i class="far fa-calendar-alt"></i>22 May 2024</div>19 Oct 2024
									<div class="kf-comm"><i class="far fa-comments"></i>Comments (7)</div>
								</div>
							</div>
						</div>
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
							<div class="kf-blog-grid-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="desc">
									...
									<div class="kf-date"><i class="far fa-calendar-alt"></i>28 Jun 2024</div>26 Nov 2024
									<div class="kf-comm"><i class="far fa-comments"></i>Comments (7)</div>
								</div>
							</div>
						</div>
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
							<div class="kf-blog-grid-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="desc">
									...
									<div class="kf-date"><i class="far fa-calendar-alt"></i>19 Oct 2024</div>22 Dec 2024
									<div class="kf-comm"><i class="far fa-comments"></i>Comments (7)</div>
								</div>
							</div>
						</div>
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
							<div class="kf-blog-grid-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="desc">
									...
									<div class="kf-date"><i class="far fa-calendar-alt"></i>26 Nov 2024</div>2 Jan 2025
									<div class="kf-comm"><i class="far fa-comments"></i>Comments (7)</div>
								</div>
							</div>
						</div>
