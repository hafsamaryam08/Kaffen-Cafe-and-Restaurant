...
@section('main-container')
		...
		<div class="wrapper">
			...
			<section class="section kf-started-inner">
				<div class="kf-parallax-bg js-parallax" style="background-image: url(frontend/assets/images/team_inner_bg.jpg);"></div>
				<div class="container">
					...
					<div class="kf-team-items row">
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
							<div class="kf-team-item element-anim-1 scroll-animate" data-animate="active">
								<div class="desc">
									...
									<div class="subname">Head Chefs</div>
								</div>
								<div class="image kf-image-hover">
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
							<div class="kf-team-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="image kf-image-hover">
									<img src="frontend/assets/images/team5.jpg" alt="" />
									<div class="info">
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
							<div class="kf-team-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="image kf-image-hover">
									<img src="frontend/assets/images/team6.jpg" alt="" />
									<div class="info">
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
							<div class="kf-team-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="image kf-image-hover">
									<img src="frontend/assets/images/team7.jpg" alt="" />
									<div class="info">
						...
						<div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
							<div class="kf-team-item element-anim-1 scroll-animate" data-animate="active">
								...
								<div class="image kf-image-hover">
									<img src="frontend/assets/images/team8.jpg" alt="" />
									<div class="info">
