		...
		<div class="wrapper">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5 align-self-center">
							...
							<div class="kf-titles">
								...
								<h3 class="kf-title element-anim-1 scroll-animate" data-animate="active">
									Relax & Savor Every Moment
								</h3>
							</div>

							<div class="kf-text element-anim-1 scroll-animate" data-animate="active">
								<p>
								At Kaffen, we create the perfect ambiance for you to unwind and enjoy delightful flavors. 
								Whether you're here for a quick coffee or a leisurely meal, every moment is crafted for comfort and indulgence.
								</p>
							</div>
							...
							<div class="kf-services-items-2 row">
								...
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
									<div class="kf-services-item-2 element-anim-1 scroll-animate" data-animate="active">
										...
										<div class="desc">
											<h5 class="name">Skilled Chefs</h5>
										</div>
									</div>
								</div>
