	              ...
	              <div class="section__comments">
	                ...
	                <div class="form-comment">
	                  <div class="comment-respond">
	                    ...
	                    <form method="post" action="{{ route('comment_submit_record') }}" class="kf-comment-form">
						@csrf
	                      <div class="row">
	                        ...
	                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	                          <div class="kf-field">
								<textarea name="comment" class="textarea" rows="3" placeholder="Comment"  required></textarea>
