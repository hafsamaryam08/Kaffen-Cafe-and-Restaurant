    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3">
            ...
            <div class="kf-logo element-anim-1 scroll-animate" data-animate="active">
                ...
                <a href="{{ route('contact') }}"><h5>Services</h5>
                <a href="{{ route('contact') }}"><h5>Reservation</h5>
                <a href="{{ route('contact') }}"><h5>History</h5>
                <a href="{{ route('contact') }}"><h5>Our Chefs</h5>
                <a href="{{ route('contact') }}"><h5>FAQs</h5>
            </div>
