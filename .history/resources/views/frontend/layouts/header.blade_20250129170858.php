...
<head>
    ...
    <meta name="twitter:creator" content="@kaffencafe">

    <!-- BEGIN CSS STYLES -->
	<link rel="icon" href="{{ asset('frontend/assets/images/fvcn.png')}}" type="image/png">
    ...
    <div class="kf-topline">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                ...
                <em>opening hours :</em> 08:00 am - 09:00 pm</div>
    ...
    <div class="kf-navbar">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                ...
                <!-- logo -->
                <div class="kf-logo">
                    <a href="{{ route('index-0') }}"><img src="{{ asset('frontend/assets/images/logo.png')}}" alt="" /></a>
                </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 align-right">
                ...
                <a href="{{ route('reservation') }}" class="kf-btn h-btn"><span>Book a table</span></a>
            </div>
        </div>
    </div>
</header>