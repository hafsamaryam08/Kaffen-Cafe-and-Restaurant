	              ...
	              <div class="content-sidebar">
	                <aside class="widget-area">
	                  ...
	                  <section class="widget widget_categories element-anim-1 scroll-animate" data-animate="active">
	                    ...
	                    <ul>
	                      <li><a href="{{ route('services') }}">Sea Food</a> (1)</li>
	                      <li><a href="{{ route('services') }}">Coffee</a> (2)</li>
	                      <li><a href="{{ route('services') }}">Recipes</a> (4)</li>
	                      <li><a href="{{ route('services') }}">Guides</a> (5)</li>
	                    </ul>
	                  </section>
	                  ...
	                  <section class="widget widget_recent_entries element-anim-1 scroll-animate" data-animate="active">
	                    ...
	                    <ul>
	                      <li><a href="{{ route('blog-single') }}">For most people, moderate coffee consumption</a></li>
	                      <li><a href="{{ route('blog-single') }}">Coffee can boost your energy levels</a></li>
	                      <li><a href="{{ route('blog-single') }}">Coffee with added milk provides all</a></li>
	                    </ul>
	                  </section>
	                  ...
	                  <section class="widget widget_tag_cloud element-anim-1 scroll-animate" data-animate="active">
	                    ...
	                    <div class="tagcloud">
	                      <a href="{{ route('blog') }}" class="tag-cloud-link">html</a>
	                      <a href="{{ route('blog') }}" class="tag-cloud-link">photo</a>
	                      <a href="{{ route('blog') }}" class="tag-cloud-link">food</a>
	                      <a href="{{ route('blog') }}" class="tag-cloud-link">chat</a>
	                      <a href="{{ route('blog') }}" class="tag-cloud-link">fashion</a>
	                      <a href="{{ route('blog') }}" class="tag-cloud-link">css</a>
	                      <a href="{{ route('blog') }}" class="tag-cloud-link">embeds</a>
	                      <a href="{{ route('blog') }}" class="tag-cloud-link">portfolio</a>
	                      <a href="{{ route('blog') }}" class="tag-cloud-link">personal</a>
	                      <a href="{{ route('blog') }}" class="tag-cloud-link">js</a>
	                    </div>
	                  </section>
	                  ...
	                  <section class="widget widget_archive element-anim-1 scroll-animate" data-animate="active">
	                    ...
	                    <ul>
	                      <li><a href="{{ route('blog-single') }}">November 2022</a>&nbsp;(11)</li>
	                      <li><a href="{{ route('blog-single') }}">October 2022</a>&nbsp;(1)</li>
	                      <li><a href="{{ route('blog-single') }}">January 2023</a>&nbsp;(5)</li>
	                      <li><a href="{{ route('blog-single') }}">August 2023</a>&nbsp;(5)</li>
	                      <li><a href="{{ route('blog-single') }}">May 2024</a>&nbsp;(6)</li>
	                      <li><a href="{{ route('blog-single') }}">December 2024</a>&nbsp;(1)</li>
	                    </ul>
	                  </section>
	                    ...
	                    <ul>
	                      <li class="recentcomments">
	                        <span class="comment-author-link">
	                          <a href="{{ route('blog') }}" class="url">Zunaisha Malik</a>
	                        </span> on <a href="{{ route('blog') }}">Tips for Capturing Authentic Pakistani Dishes</a>
	                      </li>
	                      <li class="recentcomments">
	                        <span class="comment-author-link">
	                          <a href="{{ route('blog') }}" class="url">Mahnoor Mudassar</a>
	                        </span> on <a href="{{ route('blog') }}">Exploring Traditional Pakistani Cuisine</a>
	                      </li>
	                      <li class="recentcomments">
	                        <span class="comment-author-link">
	                          <a href="{{ route('blog') }}" class="url">Inshrah Maryam</a>
	                        </span> on <a href="{{ route('blog') }}">A Guide to Pakistani Street Food Delights</a>
	                      </li>
	                    </ul>
	                  </section>
