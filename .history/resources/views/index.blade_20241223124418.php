...
<div class="wrapper">
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						...
						<div class="slide-item element-anim-1 scroll-animate" data-animate="active">
							<div class="image kf-image-hover">
								<a href="{{ asset('frontend/assets/images/grid_gal2.jpg') }}" class="has-popup-image"><img src="{{ asset('frontend/assets/images/grid_gal2.jpg') }}" alt="" /></a>
							</div>
							<div class="desc">
					...
					<div class="swiper-slide">
						...
						<div class="slide-item element-anim-1 scroll-animate" data-animate="active">
							<div class="image kf-image-hover">
								<a href="{{ asset('frontend/assets/images/grid_gal3.jpg') }}" class="has-popup-image"><img src="{{ asset('frontend/assets/images/grid_gal3.jpg') }}" alt="" /></a>
							</div>
							<div class="desc">
					...
					<div class="swiper-slide">
						...
						<div class="slide-item element-anim-1 scroll-animate" data-animate="active">
							<div class="image kf-image-hover">
								<a href="{{ asset('frontend/assets/images/grid_gal4.jpg') }}" class="has-popup-image"><img src="{{ asset('frontend/assets/images/grid_gal4.jpg') }}" alt="" /></a>
							</div>
							<div class="desc">
					...
					<div class="swiper-slide">
						...
						<div class="slide-item element-anim-1 scroll-animate" data-animate="active">
							<div class="image kf-image-hover">
								<a href="{{ asset('frontend/assets/images/grid_gal5.jpg') }}" class="has-popup-image"><img src="{{ asset('frontend/assets/images/grid_gal5.jpg') }}" alt="" /></a>
							</div>
							<div class="desc">
					...
					<div class="swiper-slide">
						...
						<div class="slide-item element-anim-1 scroll-animate" data-animate="active">
							<div class="image kf-image-hover">
								<a href="{{ asset('frontend/assets/images/grid_gal1.jpg') }}" class="has-popup-image"><img src="{{ asset('frontend/assets/images/grid_gal1.jpg') }}" alt="" /></a>
							</div>
							<div class="desc">
	...
	<section class="section kf-testimonials kf-testimonials-2 section-bg" style="background-image: url({{ asset('frontend/assets/images/testimonials_bg2.jpg') }});">
		<div class="container">
				...
				<div class="swiper-container">
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							...
							<div class="slide-item element-anim-1 scroll-animate" data-animate="active">
								<div class="image">
									<img src="{{ asset('frontend/assets/images/rev1.jpg') }}" alt="" />
								</div>
								<div class="desc">
									<div class="stars">
						...
						<div class="swiper-slide">
							...
							<div class="slide-item element-anim-1 scroll-animate" data-animate="active">
								<div class="image">
									<img src="{{ asset('frontend/assets/images/rev2.jpg') }}" alt="" />
								</div>
								<div class="desc">
									<div class="stars">
										<i class="fas fa-star"></i>
						...
						<div class="swiper-slide">
							...
							<div class="slide-item element-anim-1 scroll-animate" data-animate="active">
								<div class="image">
									<img src="{{ asset('frontend/assets/images/rev3.jpg') }}" alt="" />
								</div>
								<div class="desc">
									<div class="stars">
										<i class="fas fa-star"></i>
