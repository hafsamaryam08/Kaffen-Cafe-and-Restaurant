...
<head>
	...
	<link rel="icon" href="images/fvcn.png" type="image/png">
	...
	<!-- BEGIN CSS STYLES -->
	<link rel="stylesheet" href="{{ asset('styles/bootstrap.css') }}" type="text/css" media="all" />
	<link rel="stylesheet" href="{{ asset('fonts/font-awesome/css/font-awesome.css') }}" type="text/css" media="all" />
	<link rel="stylesheet" href="{{ asset('fonts/font-awesome/css/line-awesome.css') }}" type="text/css" media="all" />
	<link rel="stylesheet" href="{{ asset('styles/animate.css') }}" type="text/css" media="all" />
	<link rel="stylesheet" href="{{ asset('styles/magnific-popup.css') }}" type="text/css" media="all" />
	<link rel="stylesheet" href="{{ asset('styles/splitting.css') }}" type="text/css" media="all" />
	<link rel="stylesheet" href="{{ asset('styles/swiper.css') }}" type="text/css" media="all" />
