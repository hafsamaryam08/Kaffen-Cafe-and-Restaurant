...
<head>
	...
	<link rel="stylesheet" href="frontend/assets/styles/style.css" type="text/css" media="all" />
	<!-- END CSS STYLES -->
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 align-center">
                ...
                <div class="kf-main-menu">
                    <ul>
                        <li><a href="#">Home<i class="las la-angle-down"></i></a></li>
                        <li><a href="#">About</a></li>
                        <li><a href="#">Menu<i class="las la-angle-down"></i></a></li>
                        <li><a href="#">Pages<i class="las la-angle-down"></i></a></li>
                        <li><a href="#">Blog<i class="las la-angle-down"></i></a></li>
