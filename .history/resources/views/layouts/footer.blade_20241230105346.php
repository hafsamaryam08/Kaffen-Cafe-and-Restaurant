	  		...
	  		<div class="row">
	  			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 align-center">
	  				...
	  				<div class="kf-copyright element-anim-1 scroll-animate" data-animate="active">
	  					<p>© Copyrights 2024 Kaffen - Cafe & Restaurant | Developed by <a href="mailto:hafsamaryam.823@gmail.com" style="color: white;">Hafsa Maryam</a>under the supervision of <a href="mailto:jamil138.amin@gmail.com" style="color: white;">Sir Jamil</a>.</p>
	  				</div>
                      <!-- ©<?php echo date('Y'); ?> Home Bakery | Developed by <a href="mailto:hafsamaryam@gmail.com" style="color: white;">Faiza Amin</a> under the supervision of <a href="mailto:jamil138.amin@gmail.com" style="color: white;">Sir Jamil</a>. -->
	  			</div>
	  		</div>
	  	</div>
	  </div>
