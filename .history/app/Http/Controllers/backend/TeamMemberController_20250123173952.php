    ...
    public function submitTeamRecord(Request $request)
    {
        ...
        $request->validate(
            [
                ...
                'short_intro' => 'required|min:10',
                'long_intro' => 'required|min:20',
                'linkedin' => 'required|min:6',
                'instagramgram' => 'required|min:6',
        ...
        $team->short_intro = $request->short_intro;
        $team->long_intro = $request->long_intro;
