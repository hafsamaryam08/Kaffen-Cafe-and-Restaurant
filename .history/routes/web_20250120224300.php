...
// Route::post('/reservation', [ReservationController::class, 'submitRecord'])->name('reservation_submit_record');
...
// Admin Management
Route::get('/admin/register', [AdminHomeController::class, 'registerAdmin'])->name('admin.create'); // Display registration form
Route::post('/admin/register', [AdminHomeController::class, 'submitAdminRecord']); // Submit new admin record
Route::get('/admin/admins-list', [AdminHomeController::class, 'showAdminRecord'])->name('admin.show'); // Display list of admins
Route::delete('/admin/delete/{id}', [AdminHomeController::class, 'deleteAdminRecord'])->name('admin.delete'); // Delete admin record
Route::get('/admin/edit/{id}', [AdminHomeController::class, 'editAdminRecord'])->name('admin.edit'); // Display edit form
Route::put('/admin/update/{id}', [AdminHomeController::class, 'updateAdminRecord'])->name('admin.update'); // Update admin record
